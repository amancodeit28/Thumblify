...
export const featuresData: IFeature[] = [
    {
        ...
        description: "Our AI analyzes video content to suggest the most calickable concepts.",
    },
    {
    ...
    },
    {
        ...
        description: "Get fullt layered designs you can tweak to perfection if needed.",
    }
];